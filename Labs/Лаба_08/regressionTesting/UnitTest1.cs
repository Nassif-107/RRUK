...
namespace regressionTesting
{
    public class Tests
    {
        ...
        // ЛАБА 8
        [Test]
        public void FirstBonusStrategy()
        {
            var goods = new RegularGoods("Test");
            int quantity = 100;
            double price = 50;
            int totalAmount = (int)(quantity * price);

            goods.SetStrategy(totalAmount);
            int bonus = goods.GetBonus(quantity, price);

            Assert.That(bonus, Is.EqualTo(600));
        }
        [Test]
        public void DefaultBonusStrategy()
        {
            var goods = new SaleGoods("Test");
            int quantity = 100;
            double price = 40;
            int totalAmount = (int)(quantity * price);
        ...
        [Test]
        public void DefaultDiscountStrategyTest()
        {
            var goods = new RegularGoods("Test");
            int quantity = 100;
            double price = 10;
            ...
            goods.SetStrategy(totalAmount);
            int discount = (int)goods.GetDiscount(quantity, price);

            Assert.That(discount, Is.EqualTo(30));
        }
        [Test]
        public void FirstDiscountStrategyTest()
        {
            var goods = new SaleGoods("Test");
            int quantity = 100;
            double price = 20;
            ...
            Assert.That(discount, Is.EqualTo(80));
        }
        [Test]
        public void SecondDiscountStrategyTest()
        {
            var goods = new SpecialGoods("Test");
            int quantity = 100;
            double price = 40;
            int totalAmount = (int)(quantity * price);
            ...
            Assert.That(discount, Is.EqualTo(220));
        }
        // ЛАБА 7
        [Test]
